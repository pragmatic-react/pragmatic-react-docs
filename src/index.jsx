export default function Container() {
  return (
    <div>
      ...
      <aside>
        {/* 음식점 정보 모달 */}
        <RestaurantModal title="음식점 이름" description="음식점 소개 문구">
          <button className="button button--primary text-caption">닫기</button>
        </RestaurantModal>

        {/* 음식점 추가 모달 */}
        <RestaurantModal title="새로운 음식점">
          <form>
...
function RestaurantItem({ categorySrc, categoryAlt, name, description }) {
  return (
...
function RestaurantModal({ title, description, children }) {
  return (
